...
type InterestRateInputProps = {
  maxPerSecondRate: ethers.BigNumber;
  setInterestRate: (rate: ethers.BigNumber) => void;
};
  ...
  const message = useMemo(() => {
    ...
    return (
      <MessageWithTooltip
        ...
        content={
          <p>
            The pawn shop contract stores the interest rate as interest per
            second. When the rate is stored per second on submit and converted
            back to annual for display, it will vary slightly from what you
            input.
          </p>
        }
      />
