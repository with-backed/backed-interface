...
import {
  web3PawnShopContract, pawnShopContract, jsonRpcERC20Contract, web3Erc20Contract,
} from '../../lib/contracts';
...
export default function RepayCard({ account, ticketInfo, repaySuccessCallback } : RepayCardProps) {
  ...
  return (
    <fieldset className="standard-fieldset">
      ...
      <p>
        {' '}
        The current cost to repay this loan
        is
        {ethers.utils.formatUnits(amountOwed.toString(), ticketInfo.loanAssetDecimals)}
        {' '}
        {ticketInfo.loanAssetSymbol}
        .
        On repayment, the NFT collateral will be sent to the Pawn Ticket holder,
        {' '}
        {ticketInfo.ticketOwner.slice(0, 10)}
        ...
