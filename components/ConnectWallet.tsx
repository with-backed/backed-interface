...
export default function ConnectWallet({account, addressSetCallback, buttonType}){
    ...
    return(
      <div>
        ...
        <div>
          {account == null? 
          <div onClick={getAccount} id='connect-addr-button' className={`button-${buttonType}`}> Connect Address </div>
          : <div className='float-right'> 
            <p className='float-left century button-2'> {account.slice(0, 10)}... </p>
          </div>
          }
        </div>
        : 
